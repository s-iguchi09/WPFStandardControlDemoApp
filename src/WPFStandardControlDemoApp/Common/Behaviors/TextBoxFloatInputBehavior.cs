...
{
    /// <summary>
    /// Attached properties to restrict TextBox input to <see cref="float"/> values.
    /// <para>TextBox入力を <see cref="float"/> 型に制限する添付プロパティを提供します。</para>
    /// </summary>
    public class TextBoxFloatInputBehavior : TextBoxNumberInputBehaviorBase<float, TextBoxFloatInputBehavior>
    {
        /// <summary>
        /// Gets or sets the value bound to the TextBox.
        /// <para>TextBoxにバインドされる値を取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty ValueProperty = DependencyProperty.RegisterAttached("Value", typeof(float), typeof(TextBoxFloatInputBehavior), new FrameworkPropertyMetadata(0.0f, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault));
        /// <summary>
        /// Gets or sets the minimum allowed value.
        /// <para>許可される最小値を取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty MinValueProperty = DependencyProperty.RegisterAttached("MinValue", typeof(float), typeof(TextBoxFloatInputBehavior), new PropertyMetadata(float.MinValue));
        /// <summary>
        /// Gets or sets the maximum allowed value.
        /// <para>許可される最大値を取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty MaxValueProperty = DependencyProperty.RegisterAttached("MaxValue", typeof(float), typeof(TextBoxFloatInputBehavior), new PropertyMetadata(float.MaxValue));
        /// <summary>
        /// Gets or sets whether negative numbers are allowed.
        /// <para>負の数を許可するかどうかを取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty AllowNegativeProperty = DependencyProperty.RegisterAttached("AllowNegative", typeof(bool), typeof(TextBoxFloatInputBehavior), new PropertyMetadata(false));
        /// <summary>
        /// Gets or sets whether to block invalid input immediately.
        /// <para>不正な入力を即座にブロックするかどうかを取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty PreventInvalidInputProperty = DependencyProperty.RegisterAttached("PreventInvalidInput", typeof(bool), typeof(TextBoxFloatInputBehavior), new PropertyMetadata(false));
        /// <summary>
        /// Gets or sets the message for range errors.
        /// <para>範囲外エラー時のメッセージを取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty RangeErrorMessageProperty = DependencyProperty.RegisterAttached("RangeErrorMessage", typeof(string), typeof(TextBoxFloatInputBehavior), new PropertyMetadata(null));
        /// <summary>
        /// Gets or sets the message for format errors.
        /// <para>形式不正エラー時のメッセージを取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty FormatErrorMessageProperty = DependencyProperty.RegisterAttached("FormatErrorMessage", typeof(string), typeof(TextBoxFloatInputBehavior), new PropertyMetadata(null));
        ...
        public static new void SetValue(DependencyObject obj, float value) => obj.SetValue(ValueProperty, value);
        public static new float GetValue(DependencyObject obj) => (float)obj.GetValue(ValueProperty);

        public static new void SetMinValue(DependencyObject obj, float value) => obj.SetValue(MinValueProperty, value);
        public static new float GetMinValue(DependencyObject obj) => (float)obj.GetValue(MinValueProperty);

        public static new void SetMaxValue(DependencyObject obj, float value) => obj.SetValue(MaxValueProperty, value);
        public static new float GetMaxValue(DependencyObject obj) => (float)obj.GetValue(MaxValueProperty);
