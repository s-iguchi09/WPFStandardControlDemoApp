...
{
    /// <summary>
    /// Attached properties to restrict TextBox input to <see cref="double"/> values.
    /// <para>TextBox入力を <see cref="double"/> 型に制限する添付プロパティを提供します。</para>
    /// </summary>
    public class TextBoxDoubleInputBehavior : TextBoxNumberInputBehaviorBase<double, TextBoxDoubleInputBehavior>
    {
        /// <summary>
        /// Gets or sets the value bound to the TextBox.
        /// <para>TextBoxにバインドされる値を取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty ValueProperty = DependencyProperty.RegisterAttached("Value", typeof(double), typeof(TextBoxDoubleInputBehavior), new FrameworkPropertyMetadata(0.0, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault));
        /// <summary>
        /// Gets or sets the minimum allowed value.
        /// <para>許可される最小値を取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty MinValueProperty = DependencyProperty.RegisterAttached("MinValue", typeof(double), typeof(TextBoxDoubleInputBehavior), new PropertyMetadata(double.MinValue));
        /// <summary>
        /// Gets or sets the maximum allowed value.
        /// <para>許可される最大値を取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty MaxValueProperty = DependencyProperty.RegisterAttached("MaxValue", typeof(double), typeof(TextBoxDoubleInputBehavior), new PropertyMetadata(double.MaxValue));
        /// <summary>
        /// Gets or sets whether negative numbers are allowed.
        /// <para>負の数を許可するかどうかを取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty AllowNegativeProperty = DependencyProperty.RegisterAttached("AllowNegative", typeof(bool), typeof(TextBoxDoubleInputBehavior), new PropertyMetadata(false));
        /// <summary>
        /// Gets or sets whether to block invalid input immediately.
        /// <para>不正な入力を即座にブロックするかどうかを取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty PreventInvalidInputProperty = DependencyProperty.RegisterAttached("PreventInvalidInput", typeof(bool), typeof(TextBoxDoubleInputBehavior), new PropertyMetadata(false));
        /// <summary>
        /// Gets or sets the message for range errors.
        /// <para>範囲外エラー時のメッセージを取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty RangeErrorMessageProperty = DependencyProperty.RegisterAttached("RangeErrorMessage", typeof(string), typeof(TextBoxDoubleInputBehavior), new PropertyMetadata(null));
        /// <summary>
        /// Gets or sets the message for format errors.
        /// <para>形式不正エラー時のメッセージを取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty FormatErrorMessageProperty = DependencyProperty.RegisterAttached("FormatErrorMessage", typeof(string), typeof(TextBoxDoubleInputBehavior), new PropertyMetadata(null));
        ...
        public static new void SetValue(DependencyObject obj, double value) => obj.SetValue(ValueProperty, value);
        public static new double GetValue(DependencyObject obj) => (double)obj.GetValue(ValueProperty);

        public static new void SetMinValue(DependencyObject obj, double value) => obj.SetValue(MinValueProperty, value);
        public static new double GetMinValue(DependencyObject obj) => (double)obj.GetValue(MinValueProperty);

        public static new void SetMaxValue(DependencyObject obj, double value) => obj.SetValue(MaxValueProperty, value);
        public static new double GetMaxValue(DependencyObject obj) => (double)obj.GetValue(MaxValueProperty);
