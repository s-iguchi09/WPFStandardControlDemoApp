...
{
    /// <summary>
    /// Attached properties to restrict TextBox input to <see cref="long"/> values.
    /// <para>TextBox入力を <see cref="long"/> 型に制限する添付プロパティを提供します。</para>
    /// </summary>
    public class TextBoxLongInputBehavior : TextBoxNumberInputBehaviorBase<long, TextBoxLongInputBehavior>
    {
        /// <summary>
        /// Gets or sets the 64-bit integer value bound to the TextBox.
        /// <para>TextBoxにバインドされる64ビット整数値を取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty ValueProperty = DependencyProperty.RegisterAttached("Value", typeof(long), typeof(TextBoxLongInputBehavior), new FrameworkPropertyMetadata(0L, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault));

        /// <summary>
        /// Gets or sets the minimum allowed value.
        /// <para>許可される最小値を取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty MinValueProperty = DependencyProperty.RegisterAttached("MinValue", typeof(long), typeof(TextBoxLongInputBehavior), new PropertyMetadata(long.MinValue));

        /// <summary>
        /// Gets or sets the maximum allowed value.
        /// <para>許可される最大値を取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty MaxValueProperty = DependencyProperty.RegisterAttached("MaxValue", typeof(long), typeof(TextBoxLongInputBehavior), new PropertyMetadata(long.MaxValue));

        /// <summary>
        /// Gets or sets whether negative numbers are allowed.
        /// <para>負の数を許可するかどうかを取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty AllowNegativeProperty = DependencyProperty.RegisterAttached("AllowNegative", typeof(bool), typeof(TextBoxLongInputBehavior), new PropertyMetadata(false));

        /// <summary>
        /// Gets or sets whether to block invalid input immediately.
        /// <para>不正な入力を即座にブロックするかどうかを取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty PreventInvalidInputProperty = DependencyProperty.RegisterAttached("PreventInvalidInput", typeof(bool), typeof(TextBoxLongInputBehavior), new PropertyMetadata(false));

        /// <summary>
        /// Gets or sets the message for range errors.
        /// <para>範囲外エラー時のメッセージを取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty RangeErrorMessageProperty = DependencyProperty.RegisterAttached("RangeErrorMessage", typeof(string), typeof(TextBoxLongInputBehavior), new PropertyMetadata(null));

        /// <summary>
        /// Gets or sets the message for format errors.
        /// <para>形式不正エラー時のメッセージを取得または設定します。</para>
        /// </summary>
        public static readonly DependencyProperty FormatErrorMessageProperty = DependencyProperty.RegisterAttached("FormatErrorMessage", typeof(string), typeof(TextBoxLongInputBehavior), new PropertyMetadata(null));
        ...
        public static new void SetValue(DependencyObject obj, long value) => obj.SetValue(ValueProperty, value);
        public static new long GetValue(DependencyObject obj) => (long)obj.GetValue(ValueProperty);

        public static new void SetMinValue(DependencyObject obj, long value) => obj.SetValue(MinValueProperty, value);
        public static new long GetMinValue(DependencyObject obj) => (long)obj.GetValue(MinValueProperty);

        public static new void SetMaxValue(DependencyObject obj, long value) => obj.SetValue(MaxValueProperty, value);
        public static new long GetMaxValue(DependencyObject obj) => (long)obj.GetValue(MaxValueProperty);
